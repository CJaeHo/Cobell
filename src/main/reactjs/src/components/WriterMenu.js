...
const WriterMenu = ({challenge, handleDelete, handleModify}) => {
  ...
  return (
    <div className={styles.menu_wrap}>
      ...
      >
        ...
        <MenuItem onClick={handleModify} size={'small'} sx={{minHeight: '25px', fontSize:'15px', padding: '0 13px 0 10px'}}>
          <span className={`material-icons ${styles.modify_btn}`} style={{fontSize: '20px', marginRight: '5px', color: '#212529d9'}}></span>
          <span style={{lineHeight: '20px'}}>수정</span>
        </MenuItem>
      </Menu>
    </div>
  );
