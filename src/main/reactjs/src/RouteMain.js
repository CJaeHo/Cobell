...
import "./App.css";
import { Challenge, ChallengeList, Liked, NewChallenge, ModifyChallenge, Search } from "./pages/lounge";
...
import { BannerDetail } from "./pages/banner";
  ...
  return (
    <div id="main">
      <Routes>
        ...
        <Route path="/lounge/modify" element={<ModifyChallenge/>} />
