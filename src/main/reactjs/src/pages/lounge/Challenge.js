...
//       console.log(res.data);
  ...
  const motifyChallenge = () => {
    if(window.confirm("챌린지를 수정하시겠습니까?")) {
      console.log("수정" , challengeId);
      navigate('/lounge/modify', { state : {"challenge_id" : challengeId}});
    }
  }
      ...
      <div className={styles.menu_title}>
        ...
        <div className={styles.title}>챌린지</div>
        {
          ...
          challenge.leader_id == user.id ?
            <WriterMenu challenge={challenge} user={user} handleDelete={deleteChallenge} handleModify={motifyChallenge} />
             :
