...
const ProfileEdit = () => {
  ...
  useEffect(() => {
    ...
    if(imageSrc || userInfo.bio != bio || userInfo.nickname != nickname || !compareSets(userInfo.hobbyCodes, hobbyCodes)){
      setSubmit(true);
    }
    else{
      setSubmit(false);
    }
  }, [hobbyCodes, bio, imageSrc, nickname]);
    ...
    <div className={styles.profile_edit_wrap}>
      ...
      <div className={styles.wrap}>
        ...
        <div className={styles.nickname_box}>
          ...
          <input type="Text" defaultValue={userInfo.nickname} onChange={handleNickname} />
        </div>
